    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
         ...
         <li><a href="#"><?php echo ($Course_data_array_inside_course['Course']['course_name']);  ?></a></li>
...
<div class="box">
        ...
        <div class="box-header with-border">
              <h3 class="box-title">Add Chapter inside <?php echo ($Course_data_array_inside_course['Course']['course_name']);  ?></h3>
        </div>
