...
<div class="box-body">      
        ...
        <div class="form-group">
           ...
           <textarea required="true" name="data[Course][course_description]" class="textarea" placeholder="Message"
                            style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $Course['Course']['course_description']; ?> </textarea>
            </div>
        </div>
        ...
        <div class="form-group">
          ...
          <label> Sample Video</label>
            ...
            <?php if($Course['Samplevideo']['video_name'] !=' '){ ?>
            <option value="<?php echo $Course['Samplevideo']['id']; ?>"><?php echo $Course['Samplevideo']['video_name']; ?></option>
            <?php   }else{ ?>
