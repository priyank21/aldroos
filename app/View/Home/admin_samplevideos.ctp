...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Sample videos</a></li>
                ...
                <div class="box-header">
                    ...
                    <div class="box-tools">
                        <div class="input-group input-group-sm" style="width: 200px;">
                            ...
                            <input style="width:150px;float:left:!important;" type="text"  name="data[Samplevideo][search]" class="form-control pull-right" placeholder="Search">
