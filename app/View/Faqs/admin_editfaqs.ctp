...
<div class="box">
   ...
   <div class="box-body">      
        ...
        <div class="form-group">
            <div class="col-sm-8">
           <textarea required="true" name="data[Faq][answer]" class="textarea" placeholder="Message"
                            style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $data["Faq"]["answer"]; ?> </textarea>
            </div>
        </div>
