...
<table width="500" border="0" cellpadding="0" cellspacing="0" style="margin:0px auto; background:#fff; text-align:center;">
  <tr style="background:#f0f0f0;">
    <td style="text-align:center; padding-top:20px; padding-bottom:20px;">
    	<img src="http://priyank.crystalbiltech.com/droos/image/logo.png" alt="img" />  
    </td>
  </tr>
  <tr>
    <td>
    	<h2 style="font-weight:500;
		margin-bottom:1px;">Hi <?php if(!empty($user['User']['first_name'])) { echo $user['User']['first_name']; }else { echo $user['User']['email']; } ?></h2>
